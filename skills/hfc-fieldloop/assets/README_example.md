...
> - Form (optional): also in the Input Data Directory — improves M10 survey-specific proposals (and M3 Form Version / M4 Duration section detection); setup proceeds without it.
